...
TestRat::TestRat(std::string name)
	: Scene(name)
{
...
void TestRat::InitScene(float windowWidth, float windowHeight)
{
...
void TestRat::KeyboardUp()
{
}

void TestRat::KeyboardDown()
{
	auto& player = ECS::GetComponent<PhysicsBody>(MainEntities::MainPlayer());
